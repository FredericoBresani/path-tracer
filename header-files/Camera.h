...
class Camera {
    public:
        ...
        Vec3D getRight();
        int getPixelsH();
        virtual void render(std::vector<Object*> objects, std::vector<std::shared_ptr<Light>> lights, Ambient ambient);
...
void Camera::render(std::vector<Object*> objects, std::vector<std::shared_ptr<Light>> lights, Ambient ambient) {}
